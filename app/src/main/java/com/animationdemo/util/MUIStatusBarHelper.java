...
public class MUIStatusBarHelper {
    ...
    public static void translucent(Activity activity, @ColorInt int colorOn5x) {
        ...
        // 小米和魅族4.4 以上版本支持沉浸式
        if (MUIDeviceHelper.isMeizu() || MUIDeviceHelper.isMIUI()) {
...
//            }
    ...
    private static boolean isMIUICustomStatusBarLightModeImpl() {
        return MUIDeviceHelper.isMIUIV5() || MUIDeviceHelper.isMIUIV6() ||
                MUIDeviceHelper.isMIUIV7() || MUIDeviceHelper.isMIUIV8();
    }
    ...
    public static boolean supportTransclentStatusBar6() {
        return !(MUIDeviceHelper.isZUKZ1() || MUIDeviceHelper.isZTKC2016());
    }
    ...
    private static void initStatusBarHeight(Context context) {
        ...
        if (MUIDeviceHelper.isTablet(context)
